...
net.streiff.unreadbadge = function ()
{
   ...
   var createCircularBadgeStyle = function (imageWidth, imageHeight, canvas, text)
   {
      ...
      cxt.beginPath();
      cxt.arc(imageWidth / 2.15, imageHeight / 2.15, imageWidth / 2.15, 0, Math.PI * 2, true);
      cxt.fill();
      cxt.clip();
      cxt.closePath();
      ...
      */
      ...
      cxt.font = (imageHeight * 0.65) + "px Calibri bold";
      cxt.textAlign = "center";
      cxt.textBaseline = "middle";
      cxt.fillStyle = textColorStyle;
      cxt.fillText(text, imageWidth / 2.15, imageHeight / 2.15);
   }
